...
public class GuiRender {
    ...
    public GuiRender(Window window) {
        ...
        shaderModuleDataList.add(new Shaders.ShaderModuleData(genPath("shaders/gui/gui.vert"), GL_VERTEX_SHADER));
        shaderModuleDataList.add(new Shaders.ShaderModuleData(genPath("shaders/gui/gui.frag"), GL_FRAGMENT_SHADER));
